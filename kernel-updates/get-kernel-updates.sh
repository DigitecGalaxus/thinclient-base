...
# Parse actual yml into variables. This will create the variable `yamlendpoints_ubuntu_21_04_default_squash_path and many more. However, we only need the one for ubuntu 21.04 default squashfs 
create_variables endpoints.yml yaml
rm -f ./endpoints.yml

curl -L -o latest-kernel "https://github.com/netbootxyz${yamlendpoints_ubuntu_21_04_default_squash_path}vmlinuz"
