...
scp -i "$netbootSSHPrivateKey" -o StrictHostKeyChecking=no "/home/$netbootUser/netboot/assets/kernels/latest-kernel-version.json" "$netbootUser@$netbootIP:/home/$netbootUser/netboot/assets/$promoteEnv/$kernelFilename"
scp -i "$netbootSSHPrivateKey" -o StrictHostKeyChecking=no "$squashfsAbsolutePath" "$netbootUser@$netbootIP:/home/$netbootUser/netboot/assets/$promoteEnv/$squashfsFilename"
